...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../layouts/Light'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../data/app.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const Homepage1 = ()=>{
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        ...
        window.addEventListener("scroll", ()=>{
            if (window.pageYOffset > 300) {
                navbar.classList.add("nav-scroll");
                logo.setAttribute("src", Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../data/app.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
            } else {
                navbar.classList.remove("nav-scroll");
                logo.setAttribute("src", Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../data/app.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
            }
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../layouts/Light'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
        children: [
...
var __webpack_exports__ = (__webpack_exec__(3063));
