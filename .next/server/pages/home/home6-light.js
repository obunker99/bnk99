...
/* harmony import */ var _data_app_json__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(2806);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_Works3_slider__WEBPACK_IMPORTED_MODULE_7__, _components_Testimonials2__WEBPACK_IMPORTED_MODULE_10__]);
([_components_Works3_slider__WEBPACK_IMPORTED_MODULE_7__, _components_Testimonials2__WEBPACK_IMPORTED_MODULE_10__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const Homepage6 = ()=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        window.addEventListener("scroll", ()=>{
            if (window.pageYOffset > 300) {
                navbar.classList.add("nav-scroll");
                logo.setAttribute("src", _data_app_json__WEBPACK_IMPORTED_MODULE_15__/* .darkLogo */ .Q1);
            } else {
                navbar.classList.remove("nav-scroll");
                logo.setAttribute("src", _data_app_json__WEBPACK_IMPORTED_MODULE_15__/* .lightLogo */ .E8);
            }
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [699,676,1664,4958,4848,1690,621,6224,4091,9104], () => (__webpack_exec__(6515)));
