...
const Homepage3 = ()=>{
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        ...
        window.addEventListener("scroll", ()=>{
            if (window.pageYOffset > 300) {
                navbar.classList.add("nav-scroll");
                logo.setAttribute("src", _data_app_json__WEBPACK_IMPORTED_MODULE_12__/* .darkLogo */ .Q1);
            } else {
                navbar.classList.remove("nav-scroll");
...
var __webpack_exports__ = __webpack_require__.X(0, [699,676,1664,4958,4848,1690,1671,4091,4090], () => (__webpack_exec__(5477)));
