...
/* harmony import */ var _layouts_Light__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(371);
/* harmony import */ var _data_app_json__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(2806);
...
const AboutDark = ()=>{
    ...
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        ...
        window.addEventListener("scroll", ()=>{
            if (window.pageYOffset > 300) {
                navbar.classList.add("nav-scroll");
                logo.setAttribute("src", _data_app_json__WEBPACK_IMPORTED_MODULE_14__/* .darkLogo */ .Q1);
            } else {
                navbar.classList.remove("nav-scroll");
                logo.setAttribute("src", _data_app_json__WEBPACK_IMPORTED_MODULE_14__/* .lightLogo */ .E8);
            }
        });
    }, [
        navbarRef
    ]);
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_layouts_Light__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z, {
        children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [699,676,1664,4958,4848,1690,621,6224,569,3517,5598], () => (__webpack_exec__(2595)));
